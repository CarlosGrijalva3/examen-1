...
//---------------------------------------5---Medtodo-----MostrarProductos 
    const mostrarProductos = data => { 
         data.forEach(producto => { 
            ...
            templateCard.querySelector('h6').textContent = producto.otro  //precion
 ...
 const setCarrito = objeto =>{ //quede en cero
    const producto = {
        ...
        otro: objeto.querySelector('h6').textContent,
...
//---- --------------------------8------------Mostrar carrio
 const mostrarCarrito = () => {
    ...
    Object.values(carrito).forEach(producto => {
        ...
        templateCarrito.querySelectorAll('td')[0].textContent = producto.otro
...
const mostrarFooter = () => {
    ...
    if(Object.keys(carrito).length === 0){
        footer.innerHTML =`<th scope = "row" colspan = "5">Potencia en cada píxel.!!!</th>
        `
        return
    }
